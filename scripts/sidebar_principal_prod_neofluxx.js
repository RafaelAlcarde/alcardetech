  ...
  async function fetchPermissions() {
    ...
    try {
      const res = await fetch(
        SUPABASE_URL + '/rest/v1/vw_tenants_permissoes?tenant_key=eq.' + tenantKey + '&select=template_builder,kpis,disparo_campanha,kanban,portal_disparo&limit=1',
        {
          headers: {
            'apikey': SUPABASE_KEY,
