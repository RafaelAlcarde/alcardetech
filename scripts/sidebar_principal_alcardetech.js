(function () {
  ...
  const FEATURES = [
    ...
    { id: 'conversor_contatos',     label: 'Conversor de Contatos',  type: 'script', adminOnly: false, url: 'https://raw.githubusercontent.com/RafaelAlcarde/alcardetech/refs/heads/main/scripts/conversor_contatos.js' },
  ];
  // ============================================================
