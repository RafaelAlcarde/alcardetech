(function () {
  ...
  const FEATURES = [
    ...
    { id: 'conversor_contatos',     label: 'Conversor de Contatos',  type: 'modal', adminOnly: true, urlFn: function() { return 'https://rafaelalcarde.github.io/alcardetech/neofluxx-importer.html?account=' + getAccountId(); } },  ];
